...
namespace DLL.MarioKart
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            personajes.Add(new Corredor("Luigi", "El hermano menor de Mario, con un sombrero verde y camisa verde.", new string[] { "Verde", "Azul" }, "Humano", "Bicicleta"));
            personajes.Add(new Corredor("Peach", "La princesa del Reino Champiñón, con cabello rubio y vestido rosa.", new string[] { "Rosa", "Amarillo" }, "Humana", "Planeador"));
            personajes.Add(new Corredor("Yoshi", "Un dinosaurio verde con manchas blancas, con una lengua larga y pegajosa.", new string[] { "Verde", "Blanco" }, "Dinosaurio", "Moto"));
            personajes.Add(new Corredor("Doonkey Kong", "Un gorila fuerte y musculoso, con corbata roja.", new string[] { "Marrón", "Amarillo" }, "Gorila", "Auto"));
            personajes.Add(new Corredor("Bowser", "El archienemigo de Mario, un gran dragón con caparazón de tortuga.", new string[] { "Verde", "Rojo" }, "Dinosaurio", "Kart"));
            ...
            IPersonaje corredorSeleccionado = personajes[opcionCorredor - 1];
